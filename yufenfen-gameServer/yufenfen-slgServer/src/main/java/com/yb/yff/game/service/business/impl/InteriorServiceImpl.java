...
import com.yb.yff.game.business.InteriorBusinessHandler;
...
public class InteriorServiceImpl extends BusinessServiceImpl {
	...
	public void initBusinessHandlerMap(Map<String, Function<GameMessageEnhancedReqDTO, GameBusinessResBaseDTO>> businessHandlerMap) {
		businessHandlerMap.put("collect", businessHandler::doCollect);
		businessHandlerMap.put("openCollect", businessHandler::doOpenCollect);
		businessHandlerMap.put("transform", businessHandler::doBusiness);
	}
}
