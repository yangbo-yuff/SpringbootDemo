...
import com.yb.yff.game.business.WarBusinessHandler;
...
public class WarServiceImpl extends BusinessServiceImpl {
	@Autowired
	WarBusinessHandler businessHandler;
	...
	public void initBusinessHandlerMap(Map<String, Function<GameMessageEnhancedReqDTO, GameBusinessResBaseDTO>> businessHandlerMap) {
		businessHandlerMap.put("report", businessHandler::doBusiness);
		businessHandlerMap.put("read", businessHandler::doBusiness);
	}
}
