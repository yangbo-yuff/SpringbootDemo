...
public class MysqlBatisPlusMapperCodeGenerator {
	static final String outputRootDir = System.getProperty("user.dir") + "/yufenfen-gameServer/yufenfen-libs-data";
	...
	private static Map<OutputFile, String> getPathInfo() {
		...
		// Mapper XML 文件输出路径
		pathInfo.put(OutputFile.xml, outputRootDir + "/src/main/resources/mapper");
		return pathInfo;
	}
}
